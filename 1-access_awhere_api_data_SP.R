...
# sus archivos csv de salida se van a guardar. La siguietne linea crea una carpeta
...
for (i in(1:nrow(locations))) { 
  ...
  # Puede tambien hacer clic en el dataframe del pronostico en la pestaña "Environment"
  ...
  # Haga clic en el dataframe "observed" en la pestaña "environment" en la consola 
  ...
  # Haga clice en el dataframe "ag" de la pestaña "environment" en la consola superior derecha
  # para ver los datos.
  ...
  # Las variables LTN se calculan a partir de un rango de años.
  year_start <- 2011
  year_end <- 2018
  ...
  ltn <- weather_norms_latlng(lat, lon,
                               ...
                               # puede tambien excluir ciertos años de las variables LTN
                               exclude_years = c("2011", "2016")) 
  
  # Click the "ltn" dataframe in the "environment" tab on the top right 
  # console to see the data!  
  
  # Haga clic en el dataframe "ltn" en la pestaña "environment" en la consola superior derecha
  # para ver los datos.
