...
date_start_extended <- as.character(as.Date(date_start) - roll_window)
 ...
 #The default colors are set within the charting function.  This is for specific years lines added to chart  
