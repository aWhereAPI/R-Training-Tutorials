...
#
# Este codigo le mostrara como acceder a los datos del pronostico de aWhere a partir del
...
for (i in(1:nrow(locations))) { 
  ...
  # A continuacion, is.num() tiene el valor TRUE para columnas numericas, y FALSO en el caso contrario.
  ...
  # Cambiar la media noche (24:00) para que sean las 00:00 horas
