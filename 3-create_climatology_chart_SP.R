...
# archivo de texto con su(s) ubicacion(es) de interes. Para ellom, debe de editar el archivo de texto 
# de ejemplo "locations.txt" en la carpeta RunSet para darle formato a este archivo. Este, de tener 3 columnas 
...
# Especifique la fecha de inicio y fin de su interes.
# La fecha de inicio puede iniciar desde el 2008.
...
year_start <- 2011  # El año inicial tiene que ser igual o mayor al 2008.
year_end <- 2018 
...
for (i in 1:nrow(locations)) {
  ...
  # Convierta el grafico semanal en formato de imagen jpg
  ...
  # Para redondear/recortar decimales
  ...
  # Escribir los datos meteorologicos en un archivo .csv
  write.csv(many_data, 
